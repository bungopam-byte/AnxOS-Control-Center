# AnxOS Control Center 1.7-build144 - Private Alpha
...
- Allows the bundled local Agent to be started from Agent Control without requiring npm.
...
Install AnxOS Control Center, open Agent Control, and click `Start Agent`. The app should start the bundled local Agent from the packaged application. Node.js, npm, and a source checkout are not required for this path.
