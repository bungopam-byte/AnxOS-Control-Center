...
[
  ...
  "connectionState.key === \"unauthorized\"",
...
[
  ...
  "Agent unavailable",
  "The Agent rejected this desktop connection.",
  "Repair pairing or rotate the shared Agent token from Agent Control.",
  "The selected system is offline or unreachable.",
  "Start the Agent on that system or check the network address.",
  "Agent connection state is unavailable.",
  "Version unavailable",
