...
Node writes and long-operation writes are atomic. Node migrations preserve a
schema-versioned backup and refuse unknown future schemas.
...
packaged Desktop and standalone Agent on one shared implementation.
