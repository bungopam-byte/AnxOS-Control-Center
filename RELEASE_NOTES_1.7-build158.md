# AnxOS Control Center Version 1.7 Build 158

## Who it is for

Private Alpha administrators managing dedicated servers across Windows and Debian nodes.

## New installations

Install the signed Windows installer or Linux package and complete onboarding.
...
Use the updater metadata or download the installer from the release page.

## Repair guidance

Use Agent Control and Dependencies to repair missing prerequisites.
